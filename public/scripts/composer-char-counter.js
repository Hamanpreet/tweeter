...
$(document).ready(function() {
  ...
  //scroll-top button only appears after user has scrolled and nav button disappears(stretch)
  ...
  //scroll button to take us to top of the page and slide form down(stretch)
  $(".scroll-top").on ("click", () => {
    window.scroll(0,0);
    $(".new-tweet").slideDown();
    $("#tweet-content").focus();
